...
import {handleMoreClick,handleGameUserButtons} from "../services/handlers.js"
    ...
    return (
      <main className="game-main-wrapper">
        ...
        <section className="game-title-wrapper">
          <div className="game-title-data-wrapper">
            ...
            <aside className="game-account-first-wrapper">
              <button onClick={handleGameUserButtons} className="game-account-playing">
                <img className="game-account-star-icon" src={starIcon} alt="star icon" />
                PLAYING
              </button>
              <button onClick={handleGameUserButtons} className="game-account-beaten">
                <img className="game-account-star-icon" src={starIcon} alt="star icon" />
                BEATEN
              </button>
            </aside>
        ...
        <section className="game-account-second-wrapper">
          <button onClick={handleGameUserButtons} className="game-account-whishlist">
            <img className="game-account-star-icon" src={starIcon} alt="star icon" />
            ADD TO WHISHLIST
          </button>
          <button onClick={handleGameUserButtons} className="game-account-library">
            <img className="game-account-star-icon" src={starIcon} alt="star icon" />
            ADD TO LIBRARY
          </button>
        </section>
